...
#reading data
vector = pd.read_csv('plink2.txt', delimiter="\t")
vector1 =pd.read_csv('eigenvec.txt',delimiter=" ", header= None)
vector1=vector1.iloc[:,0:4]
diag = pd.read_csv('plink-MS.txt',delimiter=" ", header= None)
#changing col names
diag.columns = ['indx','1st','2nd','3rd','4th','MS']
vector.rename(columns={'#FID':'indx'},inplace=True)
